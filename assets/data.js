export const EXAM_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      "Apoptotic deletion of myocytes",
      "Metaplasia of skeletal muscle into adipose tissue",
      "Decrease in cell size and number via atrophy",
      "Ischemic necrosis of the gastrocnemius",
      "Hypoplastic remodeling"
    ],
    answer: 2
  },
  {
    ...
    options: [
      ...
      "Reversible cellular metaplasia",
      "Physiological hyperplasia",
      "Ischemic atrophy",
  ...
  },
  {
    ...
    options: [
      "Upregulation of the sodium-potassium pump",
      "Failure of ATP-dependent sodium pumps due to hypoxia",
      "Sudden absolute activation of apoptosis",
      "Intracellular efflux of sodium ions",
      "Intracellular condensation and fragmentation"
    ],
    answer: 1
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      "Polymerases and synthetases",
      "Catalases and superoxide dismutases",
      "Caspases involved only in hypertrophy",
      "ATP synthase"
    ],
    answer: 0
  },
  {
    ...
    options: [
      "Exclusively physiologic",
      "Programmed genetic apoptosis",
      "Invariably pathologic necrosis",
  ...
  },
  {
    ...
    options: [
      "Accidental necrotic death",
      "Pathologic metaplasia",
      "Physiologic apoptosis",
      "Severe cellular ischemic injury",
      "Chronic adaptation hyperplasia"
    ],
    answer: 2
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      "High blood pressure and rash",
      "Chest pain and rash",
      "Fatigue and high blood pressure",
      "All four parameters are signs"
    ],
    answer: 1
  },
  {
  ...
  },
  {
    ...
    options: [
      "With aggressive medical treatments",
      "Without any medical treatment",
      "Only in animal laboratory models",
      "In the subclinical stage only",
      "After the outcome stage finishes"
    ],
    answer: 1
  },
  {
  ...
  },
  {
    ...
    options: [
      "Cell shrinkage and membrane condensation",
      "Failure of cell membrane ion pumps, causing sodium and water influx and cell swelling",
      "Immediate complete switch to aerobic respiration",
      "Activation of anti-apoptotic genes",
      "Extracellular efflux of all cellular calcium"
    ],
    answer: 1
  },
  {
    ...
    options: [
      "Influx of stable water molecules",
      "Free radical damage (oxidative stress)",
      "Pure physiological apoptosis signals",
      "Reversible cellular hypertrophy",
      "Upregulation of mitochondrial ATP synthase"
    ],
    answer: 1
  }
