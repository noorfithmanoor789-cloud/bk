...
export const getTotalQuestions = () => EXAM_QUESTIONS.length;
...
// Helper function to get all questions with safe access
...
// Helper function to validate student login
export const validateStudent = (username, password) => {
    return EXAM_STUDENTS.find(student => 
        student.username === username && student.password === password
    );
};

// Helper function to get student by username
export const getStudentByUsername = (username) => {
    return EXAM_STUDENTS.find(student => student.username === username);
};

// Helper function to check answer
export const checkAnswer = (questionId, selectedOption) => {
...
export const calculateScore = (answers) => {
    ...
    answers.forEach(answer => {
        if (checkAnswer(answer.questionId, answer.selectedOption)) {
            correct++;
        }
    });
    return {
        ...
        percentage: (correct / EXAM_QUESTIONS.length) * 100
    };
};

// Helper function to get option letter (A, B, C, D, E)
export const getOptionLetter = (index) => {
    return String.fromCharCode(65 + index); // A, B, C, D, E
};

// Helper function to format options for display
export const getFormattedOptions = (question) => {
